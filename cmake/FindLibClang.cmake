...
if (NOT DEFINED LLVM_INCLUDE)
  set(LLVM_INCLUDE ${CLANG_INCLUDE})
endif ()
...
if (NOT DEFINED CLANG_BUILD_INCLUDE)
  set(CLANG_BUILD_INCLUDE ${CLANG_INCLUDE})
endif ()

if (EXISTS "${CLANG_BUILD_INCLUDE}/clang/Basic/Version.inc")
  file(READ "${CLANG_BUILD_INCLUDE}/clang/Basic/Version.inc" CLANG_VERSION_DATA)
...
if ("${CLANG_VERSION}" STREQUAL "")
  message(FATAL_ERROR "Unable to parse ClangVersion from ${CLANG_BUILD_INCLUDE}/clang/Basic/Version.inc")
endif ()
...
message("-- Using Clang version ${CLANG_VERSION} from ${CLANG_BUILD_INCLUDE}/clang-c/")
