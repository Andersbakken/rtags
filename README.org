...
- Get the code
  ...
  https://andersbakken.github.io/rtags-releases/rtags-2.10.tar.bz2

  or

  https://andersbakken.github.io/rtags-releases/rtags-2.10.tar.gz
...
also be socket acivated.
 ...
 2. Add the following to =~/.config/systemd/user/rdm.service=
   ...
   ExecStart=/usr/bin/rdm -v --inactivity-timeout 300 --log-flush
   ExecStop=pkill rdm
   Restart=on-failure
