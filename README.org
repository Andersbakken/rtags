...
$ emacs src/rdm.cpp
(load-file "rtags.el")
# Go to src/rdm.cpp:39:34     if (Server *server = Server::instance())
#                                                         /|\
#                                                          |
...
#+END_SRC
  If you have installed llvm to a different place than the default
  system directories, like say /opt/llvm, you can tell cmake about it, by
  setting the variable CMAKE_PREFIX_PATH.
#+BEGIN_SRC
  cmake -DCMAKE_PREFIX_PATH=/opt/llvm .
#+END_SRC
