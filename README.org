...
https://github.com/Andersbakken/rtags-releases/blob/gh-pages/rtags.tar.bz2

or

https://github.com/Andersbakken/rtags-releases/blob/gh-pages/rtags.tar.gz

Note that these are not necessarily always up-to-date. (I know this
isn't how gh-pages are supposed to work but I couldn't figure out how
to get it work with the .io thing).
