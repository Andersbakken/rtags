...
#+BEGIN_SRC
     ...
     -I/usr/local/Cellar/llvm35/3.5.1/lib/llvm-3.5/include  -DNDEBUG -D_GNU_SOURCE -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_LIMIT_MACROS -O3  -std=c++11 -fvisibility-inlines-hidden -fno-exceptions -fno-common -Woverloaded-virtual -Wcast-qual
#+END_SRC
  2. CLANG_LIBDIR
     Usually something like this:
#+BEGIN_SRC
     $ llvm-config --libdir
     /usr/local/Cellar/llvm35/3.5.1/lib/llvm-3.5/lib
#+END_SRC
     We need this to locate clang's system headers and we will assume
     that they are located in:
     ${CLANG_LIBDIR}/clang/CLANG_VERSION_STRING/include (/usr/local/Cellar/llvm35/3.5.1/lib/llvm-3.5/lib/clang/3.5.1/include)
  ...
  2. CLANG_LIBS
     Usually something like this:
#+BEGIN_SRC
     -L/usr/local/Cellar/llvm35/3.5.1/lib/llvm-3.5/lib -lclang
#+END_SRC
