...
The default installation path is "/usr/share/bash-completion/completions".
...
in the default completion path, you have to make sure the *rtags*
bash completion file gets sourced, to get completion support.
