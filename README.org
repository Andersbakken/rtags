...
If you're building with hand-compiled llvm and clang trees, use:
#+BEGIN_SRC
$ cmake -DCLANG_ROOT=[clang source tree]
        -DLLVM_INCLUDE=[llvm source tree /include] \
        -DCLANG_BUILD_INCLUDE=[clang build directory /include] ..
#+END_SRC
