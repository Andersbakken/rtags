...
(defun rtags-enable-standard-keybindings (&optional map prefix)
  ...
  (unless prefix
    (setq prefix "C-c r"))
  (ignore-errors
    (define-key map (kbd (concat prefix " .")) (function rtags-find-symbol-at-point))
    (define-key map (kbd (concat prefix " ,")) (function rtags-find-references-at-point))
    (define-key map (kbd (concat prefix " v")) (function rtags-find-virtuals-at-point))
    (define-key map (kbd (concat prefix " V")) (function rtags-print-enum-value-at-point))
    (define-key map (kbd (concat prefix " /")) (function rtags-find-all-references-at-point))
    (define-key map (kbd (concat prefix " Y")) (function rtags-cycle-overlays-on-screen))
    (define-key map (kbd (concat prefix " >")) (function rtags-find-symbol))
    (define-key map (kbd (concat prefix " <")) (function rtags-find-references))
    (define-key map (kbd (concat prefix " [")) (function rtags-location-stack-back))
    (define-key map (kbd (concat prefix " ]")) (function rtags-location-stack-forward))
    (define-key map (kbd (concat prefix " D")) (function rtags-diagnostics))
    (define-key map (kbd (concat prefix " C")) (function rtags-compile-file))
    (define-key map (kbd (concat prefix " G")) (function rtags-guess-function-at-point))
    (define-key map (kbd (concat prefix " p")) (function rtags-dependency-tree))
    (define-key map (kbd (concat prefix " P")) (function rtags-dependency-tree-all))
    (define-key map (kbd (concat prefix " e")) (function rtags-reparse-file))
    (define-key map (kbd (concat prefix " E")) (function rtags-preprocess-file))
    (define-key map (kbd (concat prefix " R")) (function rtags-rename-symbol))
    (define-key map (kbd (concat prefix " M")) (function rtags-symbol-info))
    (define-key map (kbd (concat prefix " S")) (function rtags-display-summary))
    (define-key map (kbd (concat prefix " O")) (function rtags-goto-offset))
    (define-key map (kbd (concat prefix " ;")) (function rtags-find-file))
    (define-key map (kbd (concat prefix " F")) (function rtags-fixit))
    (define-key map (kbd (concat prefix " L")) (function rtags-copy-and-print-current-location))
    (define-key map (kbd (concat prefix " X")) (function rtags-fix-fixit-at-point))
    (define-key map (kbd (concat prefix " B")) (function rtags-show-rtags-buffer))
    (define-key map (kbd (concat prefix " K")) (function rtags-make-member))
    (define-key map (kbd (concat prefix " I")) (function rtags-imenu))
    (define-key map (kbd (concat prefix " T")) (function rtags-taglist))
    (define-key map (kbd (concat prefix " h")) (function rtags-print-class-hierarchy))
    (define-key map (kbd (concat prefix " a")) (function rtags-print-source-arguments))
    (define-key map (kbd (concat prefix " l")) (function rtags-list-results))))
